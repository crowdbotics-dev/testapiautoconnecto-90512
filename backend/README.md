...
## Project Structure
    ...
    ├── testapiautoconnecto_90512  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_90512`
...
2. Clone this repo and `cd testapiautoconnecto_90512`
